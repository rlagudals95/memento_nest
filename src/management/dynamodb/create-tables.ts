...
import { DeliveryAddressRepository } from '@modules/delivery/address/delivery-address.repository';
...
import { TempUserRepository } from '@modules/user/temp-user.repository';
...
async function bootstrap() {
  ...
  const promises = [
    ...
    app.get<ICreateTable>(DeliveryAddressRepository),
